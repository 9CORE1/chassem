...
`data.json`은 크게 세 가지 최상위 노드로 이루어져 있습니다.

### 1. `portfolioData`
각 포트폴리오 프로젝트 정보를 담고 있습니다.
```json
{
  "id": "career-1",
  "category": "career",
  ...
  "youtubeStart": "",
  "youtubeEnd": "",
  "imageUrl": "images/project-career-1.jpg"
}
```

### 2. `journeyData`
시간 순 학력, 경력, 저작, 수료 이력 데이터입니다.
```json
{
  "id": "journey-1782710976509",
  "category": "education",
  "period": "2024.03 ~ 2026.02",
  "title": "인공지능(공학석사)",
  "institution": "동의대학교",
  "description": "동의대학교 인공지능학과 석사 졸업"
}
```
...
```json
{
  ...
  "icon": "fa-robot",
  "skills": [
    "생성형 AI 실무 활용 및 교육 역량",
    "AI 교육과정·자격과정 설계 역량",
    "디지털 전환(DX) 및 업무 생산성 혁신 역량"
  ]
}
```
